...
export default function WhatsAppButton({ url }: WhatsAppButtonProps) {
  function handleClick() {
    PixelEvents.completeRegistration()
    GA4Events.whatsappClick()
  }
